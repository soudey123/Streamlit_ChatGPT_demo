...
url = 'https://www.youtube.com/channel/UC9hqAr0jzGg0QHPBxcvgYUw'

with st.sidebar:
    st.markdown("""
    # About 
    ChatGPT App Demo is a primitive tool built on GPT-3.5 to generate ideas on a given topic. 
    """)
    ...
    st.markdown(html_temp.format("rgba(55, 53, 47, 0.16)"),unsafe_allow_html=True)
    st.markdown("""
    Made by [Soumava Dey](https://www.soumavadey87.com/)
    """,
    unsafe_allow_html=True,
    )
    if st.button('Subscribe to DataScienceswithSam'):
...
if input_text:
    ...
    if prompt:
        ...
        openai.api_key = "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"
